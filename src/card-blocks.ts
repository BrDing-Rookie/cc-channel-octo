...
import { cardSupports, collapseForReduction, reduceUrlsInText, sensitivePredicate, REDUCE_INPUT_MAX, type CardCaps, type SensitivePredicate } from "./card-render.js";
